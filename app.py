...
def predict():
    ...
    ## Yixuan: could return multiple objects in one image, should be able to handle it 
    print(age_result.pred) ## the predicted output
    print(age_result.names) ##class labels list
    print(age_result.n) ## this does not indicate the number of objects
    print(emotion_result.pred)
